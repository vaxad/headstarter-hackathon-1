...
export default function Home() {
	return (
		<main
			className=" flex absolute top-[80px] left-0 min-h-screen w-full flex-col items-center justify-center px-6 md:px-16 lg:px-24 bg-slate-100 dark:bg-black  selection:bg-violet-300 text-slate-950 dark:text-slate-100">
			<div className="flex flex-col lg:flex-row gap-10">
				...
				<div className="flex flex-col h-full w-full  md:pr-14 pt-14 items-center justify-center">
					<img src="/assets/home.png" class="skew-y-12" alt="bltiz-ai home" />
				</div>
			</div>
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-full px-4 md:px-6 lg:px-20 py-14  gap-7">
